...
const Map<String, IconData> FontAwesomeIconsMap = <String, IconData>{
  ...
  // TODO: In this point, I've realized that there is a lot of Icons to replace to their
  // current versions, so we leave it for later :)
  ...
  // 'vectorSquare': FontAwesomeIcons.vectorSquare, // At least for flutter 3.38.3, this doesn't exist anymore
